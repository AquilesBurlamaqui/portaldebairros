...
class gsp_portalDeBairros_bairrocreate_gsp extends GroovyPage {
...
invokeTag('form','g',35,['url':([resource:bairroInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1413484720542L
