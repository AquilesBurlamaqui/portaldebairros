			...
			<ol class="property-list endereco">
				...
				<li class="fieldcontain">
					<span id="bairro-label" class="property-label"><g:message code="endereco.bairro.label" default="Bairro" /></span>
						...
						<span class="property-value" aria-labelledby="bairro-label"><g:link controller="bairro" action="show" id="${enderecoInstance?.bairro?.id}">${enderecoInstance?.bairro?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="pais-label" class="property-label"><g:message code="endereco.pais.label" default="Pais" /></span>
						...
						<span class="property-value" aria-labelledby="pais-label"><g:fieldValue bean="${enderecoInstance}" field="pais"/></span>
